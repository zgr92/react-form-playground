...
export default class FormElementsEdit extends React.Component {
    ...
    render() {
        ...
        const this_test_prop = this.props.element.hasOwnProperty('testProp') ? this.props.element.testProp : false;
            ...
            <div>
                ...
                { this.props.element.hasOwnProperty('label') &&
                    <div className="form-group">
                        ...
                        <div className="custom-control custom-checkbox">
                            <input id="is-test-prop" className="custom-control-input" type="checkbox" checked={this_test_prop} value={true} onChange={this.editElementProp.bind(this, 'testProp', 'checked')} />
                            <label className="custom-control-label" htmlFor="is-test-prop">
                                Some random test prop
                            </label>
                        </div>
